...
template <ctll::fixed_string input> static constexpr inline auto parse = regex_parse_t<typename regex_builder<input>::type>();
...
template <auto & input> static constexpr inline auto parse = regex_parse_t<typename regex_builder<input>::type>();
